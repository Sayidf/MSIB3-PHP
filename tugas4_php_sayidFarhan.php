        ...
        public function mencetak(){ ?>
          <fieldset class="border border-light p-3 mx-2">
            ...
            <table class="table table-dark table-striped w-auto">
              ...
              <tr>
                <th>Gaji Pokok</th>
                <td><?= number_format($this->setGajiPokok(), 0, ',', '.'); ?></td>
              </tr>
              <tr>
                <th>Tunjangan Jabatan</th>
                <td><?= number_format($this->setTunjab(), 0, ',', '.'); ?></td>
              </tr>
              <tr>
                <th>Tunjangan Keluarga</th>
                <td><?= number_format($this->setTunkel(), 0, ',', '.'); ?></td>
              </tr>
              <tr>
                <th>Zakat Profesi</th>
                <td><?= number_format($this->setZakatProfesi(), 0, ',', '.'); ?></td>
              </tr>
              <tr>
                <th>Gaji Bersih</th>
                <td><?= number_format($this->setGaber(), 0, ',', '.'); ?></td>
              </tr>
            </table>
          </fieldset>
        <?php self::$no++; }
